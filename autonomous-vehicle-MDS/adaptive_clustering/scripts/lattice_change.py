...
# edited by Jang jinhyeon, Gwak jaewoo
...
#######################################################
## road_lane_num : 길 차로 개수, current_lane_num : 현재 차량 지나고 있는 차로
        if(step_num == 145):
            road_lane_num = 2
            current_lane_num = 2
            #path_score[3] = -1000000                           #오른쪽 길 죽임

        if(step_num == 148):                       
            road_lane_num = 3
            #path_score[3] = 0                                 # 오른쪽 길 활성화

        if(step_num == 157):
            road_lane_num = 4

        if(road_lane_num == 2 and current_lane_num == 2):
            path_score[3] = -1000000                           #오른쪽 길 죽임
        elif(road_lane_num == 3 and current_lane_num == 2)
            path_score[3] = 0                           #오른쪽 길 살림
        elif(road_lane_num == 3 and current_lane_num == 3)
            path_score[3] = -1000000                           #오른쪽 길 죽임
        elif(road_lane_num == 4 and current_lane_num == 3)
            path_score[3] = 0                           #오른쪽 길 살림
        elif(road_lane_num == 4 and current_lane_num == 4)
            path_score[3] = -1000000                           #오른쪽 길 죽임

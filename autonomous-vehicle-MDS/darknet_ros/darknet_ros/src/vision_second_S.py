...
def BoundingBoxes_callback(data):
    ...
    if (5 <= step_num and step_num <= 10): #A 210 235
        pub_sign2 = True
    # pub_sign2 = True

    if (15 <= step_num and step_num <= 40): #B 395 415
        pub_sign3 = True
    # pub_sign3 = True
...
def Backup_callback(event_msg):
    ...
    # elif (25 <= step_num <= 32): #30
    #     if ((delivery_alpha_A == 'A1' and delivery_alpha_B == 'B1') or (delivery_alpha_A == 'A2' and delivery_alpha_B == 'B2') or (delivery_alpha_A == 'A3' and delivery_alpha_B == 'B3')):
    #         delivery_bool.data = True
    #     else:
    #         delivery_bool.data = False

    # elif (35 <= step_num <= 40): #40
    #     if ((delivery_alpha_A == 'A1' and delivery_alpha_B == 'B1') or (delivery_alpha_A == 'A2' and delivery_alpha_B == 'B2') or (delivery_alpha_A == 'A3' and delivery_alpha_B == 'B3')):
    #         delivery_bool.data = True
    else:
        delivery_bool_A.data = False

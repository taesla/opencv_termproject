...
if __name__ == '__main__':
    ...
    state_machine = np.zeros(9)
    prev_state_machine = np.zeros(9)
    ...
    while not rospy.is_shutdown():
        ...
        if(state_machine[0]==1):
        ...
        elif(state_machine[7]==1):
            ackermann.drive.speed = 1.5
            ackermann.drive.steering_angle = -final_angle*np.pi/180
            ackermann.drive.jerk = 0
            ackermann.drive.acceleration = 0
            ...
            if parking_finish_sign==False:
                ...
                if (time.time()-parking_finish_time<10):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    ...
                    print(2)
                elif (time.time()-parking_finish_time<16.2):
                    ackermann.drive.speed = 3.0
                    ackermann.drive.steering_angle = -28.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 2
                    print(3)
                elif (time.time()-parking_finish_time<16.5):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
            ...
            if delivery_bool_sign_A==False:
                ...
                if (time.time()-delivery_finish_time_A<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_A<1.9):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_A<6.9):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
            ...
            if delivery_bool_sign_B==False:
                ...
                if (time.time()-delivery_finish_time_B<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_B<1.9):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_B<6.9):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
        ...
        #print(state_machine)
        if((prev_state_machine[0]==1 and state_machine[1]==1) or (prev_state_machine[0]==1 and state_machine[3]==1) or (prev_state_machine[0]==1 and state_machine[4]==1) or (prev_state_machine[0]==1 and state_machine[5]==1) or (prev_state_machine[0]==1 and state_machine[6]==1) or (prev_state_machine[0]==1 and state_machine[7]==1)):

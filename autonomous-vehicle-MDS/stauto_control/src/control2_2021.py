...
def delivery_bool_callback_A(data):
    global delivery_bool_sign_A

    delivery_bool_sign_A = data.data

def delivery_bool_callback_B(data):
    global delivery_bool_sign_B

    delivery_bool_sign_B = data.data
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/adaptive_clustering/is_bool", Bool, big_obstacle_finish_callback)
    rospy.Subscriber("/delivery_bool_A", Bool, delivery_bool_callback_A)
    rospy.Subscriber("/delivery_bool_B", Bool, delivery_bool_callback_B)
    ...
    delivery_end_pub_A = rospy.Publisher('/delivery_end_A', Bool, queue_size=10)
    delivery_end_pub_B = rospy.Publisher('/delivery_end_B', Bool, queue_size=10)
    ...
    delivery_bool_sign_A = False
    delivery_bool_sign_B = False
    ...
    delivery_finish_time_A = time.time()
    delivery_finish_time_B = time.time()
    ...
    while not rospy.is_shutdown():
        ...
        if(state_machine[0]==1):
            ...
            if big_obstacle_finish_sign==False:
                ...
                # if (time.time()-big_obstacle_finish_time<0.3):
                #     ackermann.drive.speed = 0.0
                #     ackermann.drive.steering_angle = 0.0
                #     ackermann.drive.jerk = 100
                #     ackermann.drive.acceleration = 0
                #     print(1)
                if (time.time()-big_obstacle_finish_time<1.0):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -15.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-big_obstacle_finish_time<2.0):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                # elif (time.time()-big_obstacle_finish_time<10):
                #     ackermann.drive.speed = 0.0
                #     ackermann.drive.steering_angle = 0.0
                #     ackermann.drive.jerk = 100
                #     ackermann.drive.acceleration = 0
            ...
            ackermann.drive.speed = Speed_linear*3/5
            ackermann.drive.steering_angle = -final_angle*np.pi/180
            ackermann.drive.jerk = 0
            ackermann.drive.acceleration = 0
            ...
            if parking_finish_sign==False:
                ...
                if (time.time()-parking_finish_time<5):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-parking_finish_time<9.5):
                    ackermann.drive.speed = 3.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 2
                    print(2)
                elif (time.time()-parking_finish_time<11.2):
                    ackermann.drive.speed = 3.0
                    ackermann.drive.steering_angle = -28.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 2
                    print(3)
                elif (time.time()-parking_finish_time<11.5):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
            ...
            if delivery_bool_sign_A==False:
                ...
                if (time.time()-delivery_finish_time_A<0.3):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_A<1.0):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -15.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_A<1.5):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_A<6.5):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    ...
                    delivery_end_pub_A.publish(True)

        elif(state_machine[6]==1):
            #print(1)
            if delivery_bool_sign_B==False:
                ackermann.drive.speed = Speed_linear*3/5
                ackermann.drive.steering_angle = -final_angle*np.pi/180
                ackermann.drive.jerk = 0
                ackermann.drive.acceleration = 0
                ...
                if (time.time()-delivery_finish_time_B<0.3):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_B<1.0):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -15.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_B<1.5):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_B<6.5):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    ...
                    delivery_end_pub_B.publish(True)

        #print(prev_state_machine, state_machine, stop_profile_flag)
        #print(state_machine)
        if((prev_state_machine[0]==1 and state_machine[1]==1) or (prev_state_machine[0]==1 and state_machine[3]==1) or (prev_state_machine[0]==1 and state_machine[4]==1) or (prev_state_machine[0]==1 and state_machine[5]==1) or (prev_state_machine[0]==1 and state_machine[6]==1)):

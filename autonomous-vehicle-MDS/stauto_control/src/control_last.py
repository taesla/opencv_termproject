        ...
        if(state_machine[0]==1):
            ...
            if delivery_bool_sign_A==False:
                ...
                if (time.time()-delivery_finish_time_A<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_A<1.4):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -20.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_A<1.7):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 10.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_A<7.7):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
            ...
            if delivery_bool_sign_B==False:
                ...
                if (time.time()-delivery_finish_time_B<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_B<1.4):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -20.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_B<1.7):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 10.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_B<7.7):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0

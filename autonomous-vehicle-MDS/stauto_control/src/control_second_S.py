        ...
        if(state_machine[0]==1):
            ...
            if delivery_bool_sign_A==False:
                ...
                if (time.time()-delivery_finish_time_A<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_A<3.5):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -18.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_A<7):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_A<12):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
            ...
            if delivery_bool_sign_B==False:
                ...
                if (time.time()-delivery_finish_time_B<0.3):
                    ...
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time_B<3.5):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = -18.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time_B<7):
                    ackermann.drive.speed = 2.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time_B<12):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0

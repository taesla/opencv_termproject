...
def get_forward_speed(msg):
    global velocity
    velocity = msg.data/10
...
if __name__== '__main__':
  # pub=rospy.Publisher('delta_wheel',Float32,queue_size=10)
    ...
    #rospy.Subscriber("/odom",Odometry,get_odom_cb)
    rospy.Subscriber("/ERP42_speed",Float32,get_forward_speed)
    rospy.spin()
